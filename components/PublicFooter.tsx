    ...
    return (
        <footer id="contact" className="bg-slate-900 text-white pt-24 pb-12 px-6">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-16 mb-20">
                <div className="md:col-span-2">
                    <Link to="/" className="flex items-center gap-2 mb-8 text-inherit no-underline">
                        ...
                        <span className="text-3xl font-semibold italic serif">Dance House</span>
                    </Link>
                    <p className="text-slate-400 max-w-sm font-light leading-relaxed mb-8">
                        {t('hero_desc')}
                    </p>
                    <div className="flex gap-4">
                        <div className="w-10 h-10 rounded-full border border-slate-700 flex items-center justify-center hover:bg-rose-500 hover:border-rose-500 transition-all cursor-pointer">FB</div>
                        <div className="w-10 h-10 rounded-full border border-slate-700 flex items-center justify-center hover:bg-rose-500 hover:border-rose-500 transition-all cursor-pointer">IG</div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul className="space-y-6 text-sm text-slate-400 font-light">
                        <li className="flex gap-3">
                            ...
                            <span className="text-sm text-slate-400">123 Arabesque Ave<br />Brooklyn, NY 11211</span>
                        </li>
                        <li className="flex gap-3">
                            <Mail className="w-5 h-5 text-rose-500 shrink-0" />
                            <span className="text-sm text-slate-400">hello@dancehouse.com</span>
                        </li>
                        <li className="flex gap-3">
                            <Phone className="w-5 h-5 text-rose-500 shrink-0" />
                            <span className="text-sm text-slate-400">+84 (0) 90 123 4567</span>
                        </li>
            ...
            <div className="max-w-7xl mx-auto pt-12 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                <p>© 2024 Dance House Studio. All rights reserved.</p>
